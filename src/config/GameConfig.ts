...
export const MONSTER_TYPES = {
  ...
  DOOM_WRAITH: {
    ...
    gold: 50,
    color: 0x111133,
    size: { width: 42, height: 55 },
    speed: 55,
  },
};

// 층별 몬스터 풀
export const TOWER_MONSTER_POOL: Record<string, string[]> = {
  [MapType.TOWER_1]: ['SHADOW_SPRITE', 'DARK_WOLF', 'CURSED_BAT', 'BLOOD_SLIME'],
  [MapType.TOWER_2]: ['UNDEAD_KNIGHT', 'BONE_GOLEM', 'DEATH_CRAWLER', 'PHANTOM_MAGE'],
  [MapType.TOWER_3]: ['HELL_HOUND', 'DOOM_WRAITH', 'BONE_GOLEM', 'UNDEAD_KNIGHT'],
  [MapType.TOWER_4]: ['DOOM_WRAITH', 'HELL_HOUND', 'PHANTOM_MAGE', 'DEATH_CRAWLER'],
};
